...
export function UnitsSection() {
  ...
  const canCreate = checkPermission(session?.user?.roles ?? [], "org:create");
  const canUpdate = checkPermission(session?.user?.roles ?? [], "org:update");
                  ...
                  <TableBody>
                    {units.map((unit) => (
                      ...
                      >
                        ...
                        {/* Status */}
                        <TableCell>
                          <StatusBadge deletedAt={unit.deletedAt} isActive={unit.isActive} />
                        </TableCell>
